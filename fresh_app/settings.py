...
WSGI_APPLICATION = 'fresh_app.wsgi.application'
...
GRAPHQL_JWT = {
    ...
    "JWT_PAYLOAD_HANDLER": "graph_api.accounts.utils.jwt_payload",
    "JWT_DECODE_HANDLER": "graph_api.accounts.utils.jwt_decode",
}